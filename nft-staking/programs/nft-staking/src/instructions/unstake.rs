...
use crate::{state::{StakeAccount, StakeConfig, UserAccount}, errors::ErrorCode};
...
impl<'info> Unstake<'info> {
    pub fn unstake(&mut self) -> Result<()> {
        ...
        require!(time_elapsed >= self.config.freeze_period as u32, ErrorCode::FreezePeriodNotPassed);
